...
2. Resolver `feature_dir` desde `.specify/feature.json` y leer `{feature_dir}/spec.md` — extraer: descripción, alcance, user stories y criterios de aceptación.
3. Leer `{feature_dir}/tasks.md` — extraer: alcance (back/front/full-stack), entidades y contratos de API.
