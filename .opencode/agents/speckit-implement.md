...
1. Si ya tenés los artefactos de Speckit (`spec.md`, `plan.md`, `tasks.md`): ejecutar el micro-prompt `.opencode/commands/speckit-to-blendverse.prompt.md` para generar `memory/{task_id}/01_requirements.md`.
